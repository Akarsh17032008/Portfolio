        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative">
              ...
              <img src={developerAvatar} alt="Akarsh P - Developer Avatar" className="relative w-80 h-80 object-cover rounded-full border-4 border-primary/30 neon-glow" />
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <p className="text-lg text-foreground-muted leading-relaxed">Passionate computer science student with a love for creating innovative digital solutions. I specialize in building modern web applications that combine cutting-edge technology with exceptional user experiences.</p>
            ...
            <div className="grid grid-cols-2 gap-4 mt-8">
              ...
              return <div key={index} className="flex items-center gap-3 p-4 rounded-lg bg-background-card/50 backdrop-blur-sm border border-primary/20 hover:border-primary/40 transition-all duration-300 card-hover">
